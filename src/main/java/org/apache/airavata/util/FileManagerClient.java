...
public class FileManagerClient {
    ...
    private String serverUrl = "http://gw77.iu.xsede.org";
    private int port = 9000;
    private XmlRpcFileManagerClient client;

    /**
     *
     * @param serverUrl OODT file server URL
     * @param port OODT file server port
     */
    public FileManagerClient(String serverUrl, int port) {
        this.port = port;
    ...
    public static void main (String args[]) {
        FileManagerClient fb = new FileManagerClient();
